...
class RandomForest(object):
    ...
    def _bootstrapping(self, XX, n):
		...
		random_idxs = np.random.choice(len(XX), n, replace=True)
		array_X = np.asarray(XX)
		bootstrap_XX = array_X[random_idxs]
		bootstrap_y = array_X[random_idxs,-1]
		return bootstrap_XX,bootstrap_y
